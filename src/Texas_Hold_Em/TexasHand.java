...
public class TexasHand
{
	...
	public TexasHand(Card[] hand, DeckOfCards deck) {
		this.hand = hand;
	...
	public TexasHand(DeckOfCards deck) {
		this.deck = deck;
	...
	public TexasHand discard(int pos) {
	...
	public TexasHand discard(int pos1, int pos2) {
		if (discarded > 0) return this;  // already discarded
	...
	public TexasHand discard(int pos1, int pos2, int pos3) {
		if (discarded > 0) return this;  // already discarded
