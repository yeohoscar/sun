...
public class FullHouse extends TexasHand {
	...
	public int getValue()	{
		if (getCard(0).getRank() == getCard(2).getRank())  // triple + pair
			return TexasHand.FULLHOUSE_VALUE + getCard(0).getValue()*100 + getCard(3).getValue();
		else
			return TexasHand.FULLHOUSE_VALUE + getCard(2).getValue()*100 + getCard(0).getValue();
	}
