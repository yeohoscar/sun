...
public class ThreeOfAKind extends TexasHand {
	...
	public int getRiskWorthiness() {
		return 100 - TexasHand.THREES_RISK;
	}
	...
	public int getValue() {
		if (getCard(0).getRank() == getCard(2).getRank())
			return TexasHand.THREES_VALUE + getCard(0).getValue()*10 + getCard(3).getValue();
		else
		if (getCard(1).getRank() == getCard(3).getRank())
			return TexasHand.THREES_VALUE + getCard(1).getValue()*10 + getCard(0).getValue();
		else
			return TexasHand.THREES_VALUE + getCard(2).getValue()*10 + getCard(0).getValue();
	}
